                        ...
                        <div class="card border-grey border-lighten-3 m-0">
                            <div class="card-header border-0">
                                <div class="card-title text-center">
                                    <div class="p-1">
                                        <img src="{{ asset('client/img/core-img/logo.png') }}" alt="branding logo">
                                    </div>
                                </div>
                                <h6 class="card-subtitle line-on-side text-muted text-center font-small-3 pt-2">
                                    <span>Register to Amado</span>
                                </h6>
                            </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <form class="form-horizontal form-simple" action="{{ url('/register') }}" method="post" novalidate>
                                        ...
                                        <fieldset class="form-group position-relative has-icon-left">
                                            <input type="text" name="nama" class="form-control form-control-lg input-lg" placeholder="Nama" value="{{ @old('nama') }}" required>
                            ...
                            <div class="card-footer">
                                <div>
                                    <p class="float-sm-right text-center m-0">Already member? <a href="{{ url('/login') }}" class="card-link">Sign In</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
